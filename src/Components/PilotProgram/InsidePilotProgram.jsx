        ...
        <>
            ...
            >
                <div className="w-full h-full flex flex-col items-center justify-center relative z-[2] space-y-[5vw]">
                    <div className="text-center  space-y- mt-10 max-sm:space-y-10">
                ...
                <div className='h-[42vw] w-[85vw] fadeup background-glass rounded-[2vw] border border-[#88888880] py-[3vw] pb-[4vw] px-[3vw]'>
<table className="table-auto w-full h-full text-left border-collapse ">
  <thead>
    <tr>
      <th className='w-[15%] text-[2.3vw] font-head text-[#F26B0D] font-normal border border-[#59595980] border-t-0 border-l-0 pb-[1vw]'>Features</th>
      <th className='w-[15%] text-[2.3vw] font-head text-white-200 font-normal border border-[#59595980] border-t-0 pl-[2vw]  pb-[1vw]'>Pilot Program</th>
      <th className='w-[15%] text-[2.3vw] font-head text-white-200 font-normal border border-[#59595980] border-t-0 border-r-0 pl-[2vw] pb-[1vw]'>Post Pilot Subscription</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td className='text-white-300 border border-[#59595980] pl-[2vw] pb-[2vw] pt-[1vw] pr-[2vw]'>1 Custominsurance use case built by DSW</td>
    ...
    <tr>
      ...
      <td className='text-white-300 border border-[#59595980] pl-[2vw] pb-[2vw] pt-[1vw] pr-[2vw]'>Build upto 4 additional use cases internally</td>
     ...
     <tr>
      ...
      <td className='text-white-300 border border-[#59595980] pl-[2vw] pb-[2vw] pt-[1vw] pr-[2vw]'>Limited GenAI workflows withpilot support</td>
