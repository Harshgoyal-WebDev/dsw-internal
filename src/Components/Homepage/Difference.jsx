            ...
            <div className='w-full flex justify-center gap-[1vw]'>
                <div className='w-[40%] space-y-[2.5vw]'>
                    ...
                    <div className='w-full flex-col flex gap-[0.5vw]'>
                        <div className='w-full bg-white/5 text-[#cacaca] text-center h-[12vh] backdrop-blur-sm border border-white/20 rounded-[1.8vw] px-[2vw] py-[2.5vw] flex items-center justify-center fadeup'>
