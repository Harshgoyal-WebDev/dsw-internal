...
export const SocialLink = ({ 
  ...
  const variants = {
    default: "rounded-full block p-2.5 border overflow-hidden bg-white/10 group-hover:bg-white group-hover:scale-[0.95] duration-300",
    footer: "rounded-full block p-2.5 border overflow-hidden bg-white/10 group-hover:bg-white group-hover:scale-[0.95] duration-300",
