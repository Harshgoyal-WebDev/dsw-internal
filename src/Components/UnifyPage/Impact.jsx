...
const POINTS = [
  { id: '01',title:"Connect", text: 'Integrate data pipelines, APIs, and enterprise systems ',width:"w-full" },
  { id: '02',title:"Configure", text: 'Build or select from pre-designed model/agent blueprints ',width:"w-full" },
  { id: '03',title:"Deploy", text: 'Launch with production-grade infrastructure, fast ',width:"w-full" },
  { id: '04',title:"Govern", text: 'Monitor usage, ensure compliance, and scale on demand ', width:"w-[60%] max-sm:w-full" },
];
  ...
  return (
    <section className="w-screen container" id="about">
      <div className="w-full flex flex-col items-center justify-center gap-y-[5vw] max-sm:gap-y-[15vw]">
        ...
        <Copy>
        <p className='text-white-300'>Here’s how UnifyAI gets you from build to business outcomes</p>
        </Copy>
        </div>
...
<Copy>
  <p className='text-[1.5vw] max-sm:text-[4.2vw] text-white-200' >{title}</p>
</Copy>
             <Copy>
