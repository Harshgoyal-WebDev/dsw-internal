    ...
    return (
        <div className=" text-foreground max-sm:py-[5vw] ">
            ...
            <form className="relative max-sm:px-[5vw]">
                <input type="email" placeholder="Enter your email" className="w-full  pb-2 !border-none !outline-none placeholder:text-[#F1F1F1] max-sm:px-[4vw] max-sm:placeholder:text-[3vw]" />
