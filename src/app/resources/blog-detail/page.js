...
export const metadata = getPageMetadata({
  ...
  description: "Explore how generative AI is reshaping insurance - from claims automation to fraud detection - with guidance on governance, security, and real-world use cases.",
