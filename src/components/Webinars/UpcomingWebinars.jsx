...
const mainAnnouncement = {
    ...
    alt: "dsw-launches",
    title:
      "Deploying GenAI for Claims Automation",
    description:
  ...
  const secondaryAnnouncements = [
    ...
    },
    {
      ...
      alt: "unifyai-achieves",
      title:
        "AI in Insurance: Roadmap to Production in 30 Days",
        type:"Workshop",
      date: "August 2, 2025",
      href: "/",
    },
    {
      ...
      alt: "unifyai-achieves",
      title:
        "UnifyAI Showcase: What's New This Quarter",
...
const UpcomingWebinars = () => {
  return (
    <section className="container" id="announcement">
        ...
        <div className="w-1/2 space-[5vw]">
      <h2 className=" text-100  headingAnim">
       Upcoming Webinars & Events
      </h2>
      <Copy>
        <p>See how DSW is making waves across global tech and AI publications. Explore press features, interviews with our leadership, and industry mentions.</p>
      </Copy>
      </div>
