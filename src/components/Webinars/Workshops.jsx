...
const Workshops = () => {
  return (
   <section className="container relative z-[10] max-sm:mt-0 mb-[7vw]" id="workshops">
           <div className="space-y-[7vw] max-sm:space-y-[20vw]">
           <div className="w-full space-y-[3vw] max-sm:space-y-[7vw]">
            <h2 className="text-90 headingAnim  max-sm:w-full text-center">AI workshops</h2>
                   <Copy>
                    ...
                    <div className="w-full flex justify-between fadeup pt-[3vw]">
                             {secondaryAnnouncements.map((item, index) => (
                               <div
                                 key={index}
                                 className="w-[47.5%] h-fit flex flex-col gap-[1.5vw] "
                               >
                                 <div className="w-full h-[25vw] rounded-[1.2vw] overflow-hidden group">
                                   <Image
                                     src={item.image}
                                     alt={item.alt}
