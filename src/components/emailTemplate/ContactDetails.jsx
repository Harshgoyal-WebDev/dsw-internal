...
const ContactDetails = ({ userName, userEmail, userDesignation, userCompany, userNumber,userReason, userMessage }) => {

  return (
    <Html>
      <Head />
      <Preview>
        Someone just filled Contact Details on DSW Website.
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section>
           ...
           <Row style={row}>
              <Column style={columnHead}>Reason</Column>
              <Column style={columnText}>{userReason}</Column>
            </Row>
