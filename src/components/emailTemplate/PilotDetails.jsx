...
const PilotDetails = ({ userName, userEmail, userDesignation, userCompany, userNumber, userTerms, userMessage, pageUrl }) => {

  return (
    <Html>
      <Head />
      <Preview>
        Someone just filled Pilot form Details on DSW Website.
      </Preview>
      <Body style={main}>
