  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-start w-full h-full pt-[30vh] relative z-[12] max-md:pt-[15vh]  content-container">
        <div
          className={`text-center space-y-6 pb-5 max-md:w-[100%] max-md:space-y-[7vw] w-[90%]`}
        >
          <h1
            ref={headingRef}
          ...
          <div ref={imgWrapRef} className="flex items-center justify-center gap-10">
           <div
              ...
              className="h-auto w-[8vw]  max-sm:w-[60vw] max-md:w-[45vw]  will-change-transform will-change-opacity"
            >
              <Image
