  ...
  return (
   <section className='h-full w-screen background-radial py-[7%]' id='careers'>
    <div className='h-full w-full container'>
        <div className=' w-full  h-full space-y-[5vw] max-sm:space-y-[8vw] flex items-start max-md:flex-col justify-between rounded-[2.5vw] max-md:rounded-[5vw] max-sm:rounded-[7vw] border border-white/20 overflow-hidden p-5'>
        ...
        <div className='w-[45%] h-[35vw] max-md:w-full rounded-[2.5vw] max-md:rounded-[5vw] max-sm:rounded-[7vw] overflow-hidden max-sm:h-[60vw]  max-md:h-[50vw]  fadeup'>
