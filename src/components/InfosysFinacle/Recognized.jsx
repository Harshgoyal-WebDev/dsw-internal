  ...
  return (
   <section className='h-full w-screen background-radial py-[7%]' id='careers'>
    <div className='h-full w-full container'>
        <div className=' w-full  h-full space-y-[5vw] max-sm:space-y-[8vw] flex items-start justify-between rounded-[2vw] border border-white/20 overflow-hidden p-5'>
        <div className='w-[60%]  max-sm:w-full max-sm:space-y-[5vw] max-md:items-start pt-[5%] px-[2%]'>
          <Copy>
