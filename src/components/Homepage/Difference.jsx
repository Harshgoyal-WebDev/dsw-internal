          ...
          <div className="w-full flex justify-center max-md:gap-[4vw] gap-[1vw] max-md:justify-between max-sm:gap-[10vw]">
            <div className="w-[40%] max-sm:w-[50%] max-md:w-full space-y-[2.5vw] max-md:space-y-[12vw]">
              ...
              <div className="w-full flex-col flex gap-[0.5vw] max-md:gap-[3vw]" ref={cardsRef1}>
                <div className="stacked-card w-full text-[#cacaca] text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw] flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px] ">
            ...
            <div className="w-[40%] max-md:w-full max-sm:w-[50%] space-y-[2.5vw] max-sm:space-y-[21vw] max-md:space-y-[12vw]" ref={cardsRef2}>
              ...
              <div className="w-full flex-col flex max-md:mt-[9.2vw] max-sm:mt-0 gap-[0.5vw]  max-md:gap-[3vw]">
                ...
                <div className=" stacked-card w-full text-[#cacaca] text-center  max-md:py-[5vw] max-sm:py-[2.5vw] h-[11vh] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw]  flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
                  30 days or less for AI, hours for GenAI 
                </div>
                <div className="stacked-card w-full text-[#cacaca] text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw] px-[6vw] flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
                  Built-in Compliance (SOC 2, ISO, HIPAA, GDPR compliant) ​
                </div>
                <div className="stacked-card w-full text-[#cacaca] text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw]  flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
                  Unified AI platform, no vendor lock-in  
                </div>
                <div className="stacked-card w-full text-[#cacaca] text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw]  px-[2vw] flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
