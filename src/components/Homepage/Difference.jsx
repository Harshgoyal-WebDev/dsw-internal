...
const Difference = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
    >
      <h2 className="text-60 headingAnim max-md:!text-[11.5vw] max-md:pl-[7vw] max-md:w-[90%]  text-center mb-[7vw] max-md:text-left max-md:justify-start max-md:mb-[20vw] text-white-200">
        ...
        <div className="w-full flex flex-col justify-center items-center gap-[4.5vw] relative z-[2] max-md:items-start max-md:w-[170vw] max-md:px-[7vw]">
          <div className="w-full flex justify-center max-md:gap-[4vw] gap-[1vw] max-md:justify-between max-sm:gap-[10vw]">
            <div className="w-[40%] max-sm:w-[50%] max-md:w-full space-y-[2.5vw] max-md:space-y-[12vw]">
              <h3 className="text-center text-40 headingAnim text-white-200 max-sm:w-[70%] max-md:w-full max-sm:text-left max-md:justify-start">
                Traditional AI Platforms
              </h3>
              <div className="w-full flex-col flex gap-[0.5vw] max-md:gap-[3vw]" ref={cardsRef1}>
                <div className="text-[1.05vw] stacked-card w-full text-white-300 text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw] flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px] ">
            ...
            <div className="w-[40%] max-md:w-full max-sm:w-[50%] space-y-[2.5vw] max-sm:space-y-[21vw] max-md:space-y-[12vw]" ref={cardsRef2}>
              ...
              <div className="w-full flex-col flex max-md:mt-[9.2vw] max-sm:mt-0 gap-[0.5vw]  max-md:gap-[3vw]">
                ...
                <div className="text-[1.05vw] stacked-card w-full text-white-300 text-center  max-md:py-[5vw] max-sm:py-[2.5vw] h-[11vh] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw]  flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
                  30 days or less for AI, hours for GenAI 
                </div>
                <div className="text-[1.05vw] stacked-card w-full text-white-300 text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw] px-[7vw] flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
                  Built-in Compliance (SOC 2, ISO, HIPAA, GDPR compliant) ​
                </div>
                <div className="text-[1.05vw] stacked-card w-full text-white-300 text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw]  flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
                  Unified AI platform, no vendor lock-in  
                </div>
                <div className="text-[1.05vw] stacked-card w-full text-white-300 text-center h-[11vh]  max-sm:py-[2.5vw] max-sm:h-[9vh] max-sm:rounded-[4.5vw]  border border-white/20 rounded-[1.6vw]  px-[3vw] flex items-center justify-center  background-glass-diff max-sm:text-[3.2vw] max-sm:px-[7vw] max-sm:text-left max-sm:justify-start backdrop-blur-[5px]">
