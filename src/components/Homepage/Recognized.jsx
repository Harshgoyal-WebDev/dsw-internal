...
const AwardItem=({img, title , year})=>{
    return (
        <>
        <div
        className="flex-shrink-0 flex items-center justify-center gap-[1vw] w-[30vw] max-md:w-[70vw] max-md:gap-[2vw]" 
      >
        <div className='w-[7vw] h-auto max-md:w-[20vw]'>
          <Image
            src={img}
            height={146}
            width={128}
        ...
        <div className="space-y-[1vw]">
          <p className="font-display text-[1.565vw] text-[#E8E8E8] max-md:text-[4.5vw]">{title}</p>
