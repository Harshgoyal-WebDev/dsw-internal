...
const EnterpiseAgentPlatform = () => {
  ...
  const handleSkip = () => {
    const next = document.getElementById("tour");
          ...
          <div className="w-full flex items-start justify-between fadeup">
            ...
            <div className="flex w-[20%] gap-5">
              ...
              <div className="text-black/50 space-y-[7vh] mt-[-0.3vh] text-[1vw] font-light">
                <p className="tags w-[65%]" ref={addToTagRefs}>
                  Deploy Agents Fast
                </p>
                <p className="w-[65%] tags" ref={addToTagRefs}>
            ...
            <div className="w-[40vw] relative">
              ...
              >
                ...
                <p className="text-black content-p w-[88%] py-8">
                  Launch production-grade agents, tasks, and workflows in
                  hours.​
                </p>
                <WhiteButton
              ...
              >
                ...
                <p className="text-black content-p w-[88%] py-8">
                  Build high-accuracy retrieval workflows with evaluation and
                  controls.
                </p>
                <WhiteButton
                  background="border-primary-2 border bg-transparent hover:bg-transparent"
              ...
              >
                ...
                <p className="text-black content-p w-[88%] py-8">
                  Coordinate multi-agent plans, A2A collaboration, and
              ...
              >
                ...
                <p className="text-black content-p w-[88%] py-8">
                  Runtime guardrails, audit trails, and native human-in-the-loop
                  oversight.
                </p>
                <WhiteButton
                  background="border-primary-2 border bg-transparent hover:bg-transparent"
...
export default EnterpiseAgentPlatform;
