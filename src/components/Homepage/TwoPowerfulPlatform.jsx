  ...
  return (
    ...
    {/* <section className="background-radial min-h-[40vh] container h-fit flex items-center justify-center ">
      ...
      <section className="min-h-screen h-fit flex flex-col items-center justify-center space-y-[5vw] bg-[#f8f8f8] container max-md:min-h-fit max-md:space-y-[8vw] max-md:py-[10vw]">
        <h2 className="text-center w-[75%] headingAnim text-primary-1 text-90 max-md:w-[90%] max-md:text-[8vw]">
          Two Powerful Platforms. One Intelligent Layer for your Enterprise.
        </h2>
        <div className="w-full h-full flex items-center w-[80%] justify-center gap-[2.5vw] max-md:flex-col max-md:w-[90%] max-md:gap-[5vw]">
          <div 
            className="w-[40%] h-fit min-h-[22vw] overflow-hidden relative flex items-start justify-center flex-col px-[3vw] py-[3vw] text-background space-y-[2.5vw] border border-[#88888880] rounded-[2vw] cursor-pointer max-md:w-full max-md:min-h-[50vw] max-md:px-[6vw] max-md:py-[6vw] max-md:space-y-[5vw] max-md:rounded-[4vw] max-md:items-center max-md:text-center"
