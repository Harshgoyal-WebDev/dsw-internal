        ...
        <div className={`inset-0 w-full relative border rounded-[1.5vw] border-white/10 ${ isOpen ? "bg-gradient-to-r from-light-blue to-dark-blue" :"bg-[#030815]"}  `}>
          <div className="relative w-full h-full z-10 px-[3vw] max-sm:rounded-[2.5vw] content  duration-300 max-sm:px-0">
            <button
              ...
              className={`cursor-pointer w-full h-full py-[2.5vw] max-sm:pb-[7vw] flex items-start ${isOpen ? "pb-[4vw]":"pb-0"}`}
            >
              ...
              <div
                className={` h-auto relative duration-500 max-sm:w-[12vw] rounded-full border-[1.5px] ml-[3vw] p-[2vw]  transition-all  ease-out max-sm:p-[6vw] max-md:p-[4vw] max-md:w-[10vw] max-md:h-[10vw] ${ isOpen ? "border bg-white" :" background-glass border-white/20"}  ${
