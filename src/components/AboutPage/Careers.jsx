  ...
  return (
   <section className='h-full w-screen background-radial' id='careers'>
    <div className='h-full w-full container'>
        <div className=' w-full border border-white/10 h-full px-[5vw] py-[5vw] max-sm:py-[8vw] max-sm:rounded-3xl rounded-[1.5vw] flex items-center max-sm:flex-col-reverse max-sm:gap-[8vw] justify-between background-glass fadeup'>
