...
export default function Unifying() {
 ...
 <div className="flex justify-end items-start gap-[3vw]">
            <div className="w-[48%] fadeup">
  ...
  <div className="w-fit flex flex-col items-start gap-[1vw]">
