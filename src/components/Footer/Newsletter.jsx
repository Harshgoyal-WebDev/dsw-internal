...
const Newsletter = () => {
  return (
    ...
    <div className=" text-foreground  max-md:flex max-md:flex-col max-md:justify-center max-md:items-center max-sm:py-[5vw] max-md:py-[3vw] relative max-sm:items-start ">
      ...
      <button
        type="button"
        className="flex cursor-pointer absolute right-0 items-center gap-1 bottom-2  group hover:scale-[0.95] transition-all duration-300 ease max-md:right-15 max-sm:right-5 bg-gradient-to-r from-primary-2 to-primary-3 text-white rounded-full px-5 py-3 max-md:bottom-8 max-sm:bottom-6 "
      >
