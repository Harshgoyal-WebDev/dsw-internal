    ...
    <>
      ...
      >
        ...
        <div className="absolute right-[4%] top-[4%] z-[5] rounded-full flex items-center justify-center h-[5vw] w-[5vw] max-sm:h-[18vw] max-sm:top-[7%] max-sm:w-[18vw] max-md:w-[12vw] max-md:h-[12vw] border border-white/20">
          <p className="text-white-200 max-sm:text-[4vw] max-md:text-[3vw] text-[1vw]">
            {duration}
          </p>
        </div>
          ...
          <div className="w-full  max-md:space-y-[3vw] py-[2vw] max-sm:mt-[8vw] mt-[1vw]">
            <ul className={`list-disc text-white-200 pl-[2vw] ${space}`}>
              {list.map((item, index) => (
                <li
                  key={index}
                  className="text-white-300 text-[1.05vw] max-md:text-[2.5vw] max-sm:text-[4vw]"
                >
                  <span className="!font-medium max-md:w-full text-white-200">
                    {item.heading}{" "}
                  </span>{" "}
                  {item.para}
                </li>
