...
export default function Hero({ breadcrumbs }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 h-full w-full z-0 hero-img opacity-0">
        <Image
          width={1920}
          height={1080}
      ...
      <h1 className="text-100 headingAnim max-md:hidden relative z-10 text-white-200 text-center opacity-0 hero-head w-[85%]">
        How Generative AI is Transforming the Insurance Industry
      </h1>

      {breadcrumbs && (
        <div className="breadcrumbs overflow-hidden w-full flex items-start justify-start text-[1vw] text-[#CACACA] max-md:text-[4vw] max-md:h-fit absolute left-[5%] bottom-[8%] max-sm:top-[90%] max-md:top-[85%] z-[999] opacity-0 hero-crumb">
