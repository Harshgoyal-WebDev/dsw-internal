...
const Hero = ({ heroData }) => {
  ...
  return (
    <section className="h-[70vw] w-screen relative bg-background max-sm:h-[75vh] max-sm:px-[7vw]" id="hero">
      <div className="flex flex-col items-center justify-start max-sm:justify-center w-full h-full pt-[30vh] relative z-[12] max-sm:pt-[15vh]">
        <div className="w-[50%] text-center space-y-6 pb-5 max-sm:w-[100%] max-sm:space-y-[12vw]">
          <h1
            ref={heading}
