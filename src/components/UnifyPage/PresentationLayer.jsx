  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-sm:py-[1.5vw] py-[.7vw] max-sm:rounded-[3vw]  border-white/20 text-[1.5vw] rounded-full border bg-gradient-to-r from-white/0 to-white/6"
      >
        <p className="text-[1.5vw]  max-sm:text-[4.5vw]">Presentation Layer</p>
      </div>

      <div
        ref={UseCaseRef}
        className="space-y-[1vw] max-sm:space-y-[2vw] px-[1vw] w-full py-[1vw] border-white/20 max-sm:px-[3vw] max-sm:py-[3vw] rounded-[2vw] max-sm:rounded-[4vw] border bg-gradient-to-r from-white/0 to-white/6"
      >
        <p className="text-[1.5vw] max-sm:text-[4.5vw]">Use Cases</p>
        <div className="flex max-sm:gap-[2vw] gap-[1vw] max-sm:flex-col items-center justify-evenly">
          {usecaseLayer.map((text, index) => (
            <p
              key={index}
              className="w-fit max-sm:w-full max-sm:text-[3.5vw] py-[1vw] px-[1.6vw] text-[1vw] bg-gradient-to-r from-white/2 to-white/8 border-white/20 rounded-[1vw] max-sm:rounded-[1.2vw] max-sm:py-[1.5vw] border text-white-300"
            >
              {text}
            </p>
          ))}
      ...
      <div className="h-fit flex max-sm:flex-col max-sm:gap-[3vw] gap-[.8vw] w-full">
        <div ref={AIStudioRef} className="h-full overflow-hidden ">
          <div className="h-fit p-[1.5vw] text-center w-full bg-gradient-to-r from-white/8 to bg-white/0 border-white/20 rounded-[2vw] max-sm:rounded-[4vw] flex flex-col max-sm:p-[4vw] items-center gap-[.5vw] border">
            <div className="w-full h-full">
              <p className="text-[1.5vw] max-sm:text-[4vw] ">AI Studio</p>
            ...
            <div className="w-full h-full">
              <div className="py-[1vw] max-sm:py-[6vw] flex-nowrap relative flex justify-evenly items-start w-full pl-[5vw]">
                ...
                <div className="flex-row flex-wrap justify-center gap-x-[5vw] gap-[0.5vw] flex w-full items-center">
        ...
        <div ref={GenAIStudioRef} className="h-full w-full">
          <div className="h-fit bg-gradient-to-l from-white/8 to bg-white/0 p-[1.5vw] max-sm:p-[4vw] text-center w-full border-white/20 max-sm:rounded-[4vw] rounded-[2vw] flex flex-col items-center gap-[.5vw] border">
            <div className="w-full h-full">
              <p className="text-[1.5vw] max-sm:text-[4vw]">Gen AI Studio</p>
            ...
            <div className="w-full flex items-start justify-center h-fit">
              <div className="py-[1.4vw] max-sm:w-full max-sm:py-[6vw] flex-nowrap relative flex justify-evenly items-center w-full max-sm:pr-0 pr-[5vw]">
                ...
                <div className="flex-row flex-wrap max-sm:items-center max-sm:justify-start justify-center gap-x-[4vw]  max-sm:gap-[4vw] gap-[2vw] flex w-full items-center">
      ...
      <div
        ref={UnifyRef}
        className="w-full flex items-center justify-center bg-gradient-to-r from-white/0 to-white/4 border-white/20 rounded-[2vw] max-sm:rounded-[3vw] border"
      >
        <div className="h-auto max-sm:w-[25vw]  mt-[.5vw] w-[8vw]">
          <Image
            width={100}
            height={100}
