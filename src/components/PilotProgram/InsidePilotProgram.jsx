          ...
          <div className="w-full max-md:w-[200vw]  origin-left max-md:mr-[5vw] max-md:mt-[10vw] h-full max-md:overflow-x-scroll max-md:pb-[8vw] flex items-center justify-center ">
            <div className="h-[40vw] flex-shrink-0  w-[80vw] max-md:translate-x-[0%] max-md:ml-[180vw] max-md:mr-[60vw]  max-md:w-full max-md:h-full fadeup background-glass  rounded-[2vw] border border-white/20  py-[3vw] pb-[4vw] px-[3vw] max-md:px-[7vw] max-md:py-[7vw] max-md:rounded-[6vw]">
              ...
              <div className="grid grid-cols-[.8fr_1.2fr_1.8fr] border-collpase w-full h-full  border-t-0 border-l-0">
                ...
                <h3 className="text-50 font-head text-white-200 font-normal border border-white/10 border-l-0 border-t-0 pl-[2vw] pb-[1vw] max-md:text-[6vw] max-md:pl-[8vw]">
                  Pilot Program
                </h3>
                <h3 className="text-50 font-head text-white-200 font-normal border-b border-white/10  max-md:text-[6vw] pl-[2vw] pb-[1vw]  max-md:pl-[8vw]">
                ...
                <div className="text-white-300 border border-white/10 border-t-0 border-l-0  pl-[2vw] pb-[3vw] pt-[1vw] max-md:p-[7vw]">
                  Full Platform Access for 6 months
                </div>
                <div className="text-white-300 border-b border-white/10 pl-[2vw] pb-[3vw] pt-[1vw] max-md:p-[7vw]">
                ...
                <div className="text-white-300 border border-white/10  border-t-0  border-l-0 pl-[2vw] pr-[2vw] pb-[2vw] pt-[1vw] max-md:p-[7vw]">
                  1 Custom insurance use case built by DSW
                </div>
                <div className="text-white-300 border-b border-white/10  pl-[2vw] pb-[2vw] pt-[1vw] max-md:p-[7vw]">
                ...
                <div className="text-white-300 border border-white/10 border-t-0 pl-[2vw] border-l-0  pr-[2vw] pb-[2vw] pt-[1vw] max-md:p-[7vw]">
                ...
                <div className="text-white-300 border-b border-white/10 pl-[2vw] pb-[2vw] pt-[1vw] max-md:p-[7vw]">
                  Access to 300+ GenAI agents (e.g., fraud detection, claims
                  triage, policy recommendations)
                </div>
                ...
                <div className="text-white-300 border-r border-white/10 pl-[2vw] pb-[2vw] pt-[1vw] pr-[2vw] max-md:p-[7vw]">
                  1 dedicated Data Scientist + 24/7 email support
                </div>
                <div className="text-white-300   pl-[2vw] pb-[2vw] pt-[1vw] max-md:p-[7vw]">
                  Continuous expert support, technical assistance, and
                  optimization
                </div>
              </div>
            </div>
