"use client";
import React, { Suspense, useMemo, useRef, useLayoutEffect, memo,useState,useEffect,} from "react";
...
import AnimatedLine from "./AnimatedLines";
        ...
        >
            <div className="flex flex-col items-center justify-start w-full h-full pt-[30vh] relative z-[12] max-md:pt-[15vh]">
                ...
                >
                    ...
                    <p
                        ref={paraRef}
                        className={`text-[#CACACA] font-head mx-auto overflow-hidden opacity-0 ${heroData.paraClass ? heroData.paraClass : "w-full"
                            }`}
                    >
                        {heroData.para}
                    </p>
                    ...
                    <div
                        ref={btnsRef}
                        className={`flex items-center justify-center gap-6 mt-10 max-md:flex-col max-md:gap-[5vw] opacity-0 ${heroData.hidebtn ? "hidden" : "flex"
                            }`}
                    >
                        {[
                            {
