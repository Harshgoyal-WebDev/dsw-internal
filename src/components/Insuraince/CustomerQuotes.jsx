...
const panelsData = [
  ...
  },
  {
    ...
    company: "Castler ",
    description:
      "With advanced capabilities of its its GenAI Studio, Castler's escrow services became smarter, more efficient - enabling faster, secure, scalable solutions for our BFSI clients. ",
