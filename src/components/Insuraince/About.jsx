...
export default function About() {
    ...
    return (
        <div ref={containerRef} className="flex items-center  justify-between h-[80vh] max-md:h-full w-screen overflow-hidden max-md:flex-col  max-sm:h-full container relative z-[20] " id="footer-cta">
            ...
            <div className="w-[60%] max-md:w-full max-sm:!w-[100%] max-sm:text-center max-md:space-y-[4vw]  space-y-[2vw]">
                <h2 className="text-60  max-sm:text-wrap font-head  headingAnim text-white-200 max-sm:mb-[7vw] max-sm:!text-[11.5vw]">Built with Insurance DNA. Unified AI and GenAI.</h2>
                <div className="space-y-[0.5vw] max-md:space-y-[3vw]">
                    ...
                    <Copy>
                        <p className="text-white-300 w-[93%] max-sm:w-[100%]">Move from pilot to production with speed, security, and confidence on a unified platform that operationalizes AI and GenAI at scale. No complexity. Just real outcomes.</p>
                    </Copy>
                </div>
            </div>
        </div>
